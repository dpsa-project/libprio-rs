...
mod tests {
    ...
    fn secret_sharing_interop() {
        ...
        let share2 = extract_share_from_seed::<Prio2Field>(reference.len(), &seed);
    ...
    fn random_data_interop(seed_base64: &str, hash_base64: &str, len: usize) {
        ...
        let random_data = extract_share_from_seed::<Prio2Field>(len, &seed);

        let random_bytes = Prio2Field::slice_into_byte_vec(&random_data);
